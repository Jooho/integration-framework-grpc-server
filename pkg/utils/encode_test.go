...
func TestJsonSerializer(t *testing.T) {
	...
	testname := "Test converting K8S object configmap to JSON []bytes"
	t.Run(testname, func(t *testing.T) {
		serializedJson := JsonSerializer(&k8sObjConfigMap, false, false)
...
func TestConvertProtobufObj(t *testing.T) {
	...
	for i, user := range userData {
		...
		t.Run(testname, func(t *testing.T) {
			emptyUserProtobuf := &userv1.UserMessage{}
